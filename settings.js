...
global.owner = process.env.OWNER_NUMBER  || '917478172267' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=2d11kCaD#gk9uhXz_fBiGDvlQBORDyRNs1K7r8Fiqwbp0YPQshxA ' ,
...
COMMAND_TYPE: process.env.COMMAND_TYPE || 'nul' ,
LOGO: process.env.LOGO || `https://pomf2.lain.la/f/o3ubc6ap.jpg` ,
...
ALIVE: process.env.ALIVE || `i am zoya`,     
AUTO_STATUS_READ:  process.env.AUTO_STATUS_READ  || true  ,    
AUTO_VOICE:  process.env.AUTO_VOICE  || false  ,
AUTO_STICKER: process.env.AUTO_STICKER || false  ,
WELCOME:  process.env.WELCOME  || false ,
ANTI_DELETE : process.env.ANTI_DELETE || truee ,
